...
namespace TMDBMobile.Core.Redux
{
    ...
    {
        private readonly List<Tuple<PropertyInfo, Delegate>> fieldReducers = new List<Tuple<PropertyInfo, Delegate>>();
        ...
        public CompositeReducer<State> Part<T>(Expression<Func<State, T>> composer, Reducer<T> reducer)
        {
            ...
            fieldReducers.Add(new Tuple<PropertyInfo, Delegate>(member, reducer));
            return this;
        }
