...
namespace TMDBMobile.Core.Redux
{
    ...
    public class Store<State>
    {
        ...
        public AsyncActionNeedsParam<T, Result> CreateAsyncAction<T, Result>(
        ...
        public AsyncActionNeedsParam<T> CreateAsyncActionVoid<T>(
            Func<DispatcherDelegate, GetStateDelegate, T, Task> action)
        {
            return invokeParam => (dispatch, getState) => action(dispatch, getState, invokeParam);
        }

        public AsyncAction<Result> CreateAsyncAction<Result>(
